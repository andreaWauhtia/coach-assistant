...
- Nom : Maxence Jonckheere
- Poste(s) observé(s) : Attaquant / Milieu offensif
- Rôle en match : joueur de percussion, bonne participation offensive et plusieurs passes décisives notées (PD = 7 selon SportEasy).

### Objectifs personnels recommandés

- Finition : ⭐⭐⭐⭐⭐  
- Vision de jeu & passes clés : ⭐⭐⭐⭐⭐
