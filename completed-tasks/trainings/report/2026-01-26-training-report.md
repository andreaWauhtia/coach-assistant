...
**Durée** : 60 minutes
**Présents** : Firmin, Louis, Tiago, Nestor, Maxence, Lilou, Hugo, Auguste, Lysian, Natha (10 présents)
...
- **Match 5vs5** — **~12'**. Mise en application collective des acquis en duel et maîtrise du ballon.
...
- **Match 5vs5** : bonne mise en pratique, permet de travailler les duels en situation réelle. Observations détaillées : **Auguste** testé en pointe — confirme son efficacité en 1v1 (résiste aux charges) mais a tendance à redescendre trop bas ; lorsqu'il joue défense, il se place trop haut (à corriger). **Tiago** essayé 3 minutes en pointe — il marque en s'arrachant sur un ballon long (bon pour rotations courtes en pointe); montre de l'audace dans les dribbles mais manque parfois de précision dans le contrôle de balle. **Nestor** marque après un superbe geste de semelle. **Maxence** a montré une bonne "gnac" en défenseur, utile en reconstruction.
- **Ambiance** : séance plutôt studieuse, bonne concentration générale.
...
- **Maxence** — bonne "gnac" défensive; capitaliser sur son agressivité pour les duels et la récupération.
- **Lysian** — testé en attaque; semblait un peu perdu — travailler positionnement offensif, courses et repères simples.
- **Collectif** : séance plutôt studieuse; poursuivre le travail sur l'utilisation du pied faible et les exercices de rebond au Ball Mastery.
...
4. Valoriser les gestes techniques fructueux (ex : la semelle de **Nestor**) via répétitions et situations de finition. 🛠️
5. Prévoir des variantes plus courtes et plus ludiques du "train du duel" pour maintenir l'attention (relais 2–4', contraintes sonores). ⏱️
...
- `completed-tasks/trainings/exercises/1vs1_technique_duel.md` — **1vs1 technique/duel** (plan prévu : 25')  
  Description (extrait) : Saut/proprioception entre plots puis fixation du défenseur et finition. Durée réelle : ~25'. Observations : intensité bonne, organisation par groupes de 3 (Steve).
- `completed-tasks/trainings/exercises/ball_mastery_circuit.md` — **Ball Mastery (circuit)** (plan prévu : 20')  
  Description (extrait) : Toe taps, passes, modern toe tap, talonade — objectif : ancrer la maîtrise du ballon et améliorer le contrôle en 1vs1. Observations : manque de rebond, relativement peu d'utilisation du pied faible; joueurs appliqués et demandeurs.
